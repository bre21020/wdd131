...
function tagTemplate(recipe) {
    ...
    for (let i = 0; i <= tagList.length - 1; i++) {
      html += `<div class="tag">${tagList[i]}</div>`;		
    }
    return html;
}

function ratingTemplate(recipe) {
    roundRating = Math.floor(recipe.rating);
    if (roundRating == 1) {
        return `<span class="rating" role="img" aria-label="Rating: 1 out of 5 stars">
        ...
        return `<span class="rating" role="img" aria-label="Rating: 2 out of 5 stars">
              <span aria-hidden="true" class="icon-star">⭐</span>
              <span aria-hidden="true" class="icon-star">⭐</span>
              <span aria-hidden="true" class="icon-star-empty">☆</span>
              <span aria-hidden="true" class="icon-star-empty">☆</span>
        ...
        return `<span class="rating" role="img" aria-label="Rating: 3 out of 5 stars">
              <span aria-hidden="true" class="icon-star">⭐</span>
              <span aria-hidden="true" class="icon-star">⭐</span>
              <span aria-hidden="true" class="icon-star">⭐</span>
              <span aria-hidden="true" class="icon-star-empty">☆</span>
        ...
        return `<span class="rating" role="img" aria-label="Rating: 4 out of 5 stars">
              <span aria-hidden="true" class="icon-star">⭐</span>
              <span aria-hidden="true" class="icon-star">⭐</span>
              <span aria-hidden="true" class="icon-star">⭐</span>
              <span aria-hidden="true" class="icon-star">⭐</span>
...
function recipeTemplate(recipe) {
    return `
    <div class="recipeCard" id="recipeContainer">
        <div>
...
//            Desert
//        </div>
//        <p class="recipeName">Apple Crisp</p>
//        <p class="desc">This apple crisp recipe is like really super cool so you should make it. the recipe is burried somewhere in my life story, you'll have to scroll for about 3 minutes at max speed before you find it.</p>
